            ...
            <div className="z-10 text-center max-w-5xl mx-auto">
                ...
                >
                    <div className="inline-block mb-6 px-4 py-1.5 rounded-full border border-white/30 bg-white/10 backdrop-blur-sm shadow-sm">
                        <span className="text-accent font-semibold tracking-wide text-sm">AAROHAN 3.0 PRESENTS</span>
                    </div>
                ...
                >
                    ...
                    <button className="bg-white/10 backdrop-blur-sm text-white border border-white/30 px-8 py-4 rounded-full font-bold flex items-center justify-center gap-2 hover:bg-white/20 transition-all shadow-sm">
